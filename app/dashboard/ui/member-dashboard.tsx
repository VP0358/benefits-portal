          ...
          <div className="absolute right-0 top-0 h-full w-64 bg-white shadow-2xl flex flex-col"
            ...
            <nav className="flex flex-col gap-1 flex-1 px-3 py-3 overflow-y-auto">
              {[
                ...
                { href: "/mlm-status",       label: "📊 MLM状況" },
                { href: "/mlm-registration",  label: "👤 登録情報" },
                { href: "/mlm-bonus-history", label: "💰 ボーナス履歴" },
                { href: "/mlm-purchase-history", label: "📦 購入履歴" },
                { href: "/mlm-autoship",     label: "🔄 オートシップ" },
                { href: "/orders/checkout",  label: "🛍️ 商品注文" },
                { href: "/org-chart",        label: "🌳 組織図" },
                { href: "/mlm-referrer-list", label: "👥 紹介者一覧" },
                { href: "/referral",         label: "🎁 お友達紹介" },
      ...
      <main className="max-w-md mx-auto px-4 pt-5 space-y-5">
        ...
        <section id="mlm-menu">
          ...
          <div className="grid grid-cols-3 gap-2.5">
            {[
              { href: "/mlm-registration",  icon: "👤", label: "登録情報",         color: "from-slate-400 to-slate-500" },
              { href: "/mlm-bonus-history", icon: "💰", label: "ボーナス履歴",     color: "from-amber-400 to-orange-500" },
              { href: "/mlm-purchase-history", icon: "📦", label: "購入履歴",         color: "from-blue-400 to-blue-600" },
              ...
              { href: "/mlm-status",       icon: "📊", label: "状況",             color: "from-violet-400 to-purple-600" },
              { href: "/mlm-referrer-list", icon: "👥", label: "紹介者一覧",       color: "from-indigo-400 to-indigo-600" },
