          ...
          <div className="absolute right-0 top-0 h-full w-64 bg-white shadow-2xl flex flex-col"
            ...
            <nav className="flex flex-col gap-1 flex-1 px-3 py-3 overflow-y-auto">
              {[
                ...
                { href: "/mlm-member",        label: "🌿 MLM会員情報" },
                { href: "/mlm-member",        label: "👤 登録情報" },
                { href: "/mlm-member",        label: "💰 ボーナス履歴" },
                { href: "/mlm-member",        label: "📦 購入履歴" },
                { href: "/mlm-member",        label: "🔄 オートシップ" },
                { href: "/orders/checkout",  label: "🛍️ 商品注文" },
                { href: "/org-chart",        label: "🌳 組織図" },
                { href: "/points/check",     label: "📊 状況" },
                { href: "/mlm-member",        label: "👥 紹介者一覧" },
      ...
      <main className="max-w-md mx-auto px-4 pt-5 space-y-5">
        ...
        <section id="mlm-menu">
          ...
          <div className="grid grid-cols-3 gap-2.5">
            {[
              { href: "/mlm-member",        icon: "👤", label: "登録情報",         color: "from-slate-400 to-slate-500" },
              { href: "/mlm-member",        icon: "💰", label: "ボーナス履歴",     color: "from-amber-400 to-orange-500" },
              { href: "/mlm-member",        icon: "📦", label: "購入履歴",         color: "from-blue-400 to-blue-600" },
              { href: "/mlm-member",        icon: "🔄", label: "オートシップ\n確認", color: "from-cyan-400 to-teal-500" },
              ...
              { href: "/mlm-member",        icon: "👥", label: "紹介者一覧",       color: "from-indigo-400 to-indigo-600" },
