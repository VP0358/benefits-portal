...
export async function GET(req: NextRequest) {
  try {
    ...
    (doc as any).autoTable({
      ...
      head: [["\u9805\u76EE", "\u9707\u984D"]],
      body: [
        ["\u30C0\u30A4\u30EC\u30AF\u30C8\u30DC\u30FC\u30CA\u30B9", yen(result.directBonus)],
        ["\u30E6\u30CB\u30EC\u30D9\u30EB\u30DC\u30FC\u30CA\u30B9", yen(result.unilevelBonus)],
        ["\u7D44\u7E54\u69CB\u7BC9\u30DC\u30FC\u30CA\u30B9", yen(result.structureBonus)],
        ["\u8C37\u91D1\u30DC\u30FC\u30CA\u30B9", yen(result.savingsBonus)],
        ["\u7E70\u8D8A\u91D1", yen(result.carryoverAmount)],
        ["\u8ABF\u6574\u91D1", yen(result.adjustmentAmount)],
        ["\u5225\u53E3\u5EA7", yen(result.otherPositionAmount)],
        ["\u652F\u6255\u8ABF\u6574\u524D\u53D6\u5F97\u984D", yen(result.totalBonus)],
      ],
      theme: "striped",
