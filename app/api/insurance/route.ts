...
export async function POST(req: NextRequest) {
  try {
    ...
    const { memberId, name, phone, email, schedule1, schedule2, schedule3, insuranceType, products, note } = body
    ...
    const data = { memberId: memberId || "", name, phone, email, schedule1, schedule2, schedule3, insuranceType: insuranceType || "life", products: products || [], note: note || "" }
